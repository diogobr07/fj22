...
public class CandlestickFactoryTest {
	...
	@Test
	public void senquenciaSimplesDeNegociacoes() {
	...
	@Test
	public void apenasUmaNegociacaoGeraCandleComValoreIguais() {
		Calendar hoje = Calendar.getInstance();
	...
	public void paraNegociacoesDeTresDiasDistintosGeraTresCandles() {
		...
		List<Negociacao> negociacoes = Arrays.asList(negociacao, negociacao2,
